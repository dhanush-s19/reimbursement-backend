...
@Tag(name = "User Management By HR", description = "Endpoints for User Management by HR")
public class HrController {
     ...
     */
    @Operation(summary = "Adding a User", description = "For adding a new user")
    @PostMapping
     ...
     */
    @Operation(summary = "Updating a User", description = "For updating an existing user")
    @PutMapping("/{id}")
     ...
     */
    @Operation(summary = "Delete a User", description = "For deleting a user")
    @DeleteMapping("/{id}")
     ...
     */
    @Operation(summary = "Get user by Id", description = "For getting a user by id")
    @GetMapping("/{id}")
     ...
     */
    @Operation(summary = "Get all Users", description = "For getting all users")
    @GetMapping
     ...
     */
    @Operation(summary = "Search Users", description = "For searching users by name")
    @GetMapping("/search")
     ...
     */
    @Operation(summary = "Get Employees", description = "For getting a list of employees")
     ...
     */
    @Operation(summary = "Get Accountants", description = "For getting a list of accountants")
     ...
     */
    @Operation(summary = "Get HR Users", description = "For getting a list of HR users")
    @GetMapping("/hr")
     ...
     */
    @Operation(summary = "Get Managers", description = "For getting a list of managers")
    @GetMapping("/managers")
     ...
     */
    @Operation(summary = "Get HR Dashboard", description = "For getting HR dashboard statistics")
    @GetMapping("/stats")
     ...
     */
    @Operation(summary = "Update Password", description = "For updating a user's password")
